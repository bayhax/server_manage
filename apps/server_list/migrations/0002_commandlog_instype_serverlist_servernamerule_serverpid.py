    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_name', models.CharField(max_length=40, unique=True, verbose_name='服务器名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_rule_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='server_list.ServerNameRule', verbose_name='服务器进程_服务器名称规则id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_rule_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='server_list.ServerNameRule', verbose_name='服务器列表_服务器名称规则id')),
            ],
            options={
                'verbose_name': '服务器列表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_rule_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='server_list.ServerNameRule', verbose_name='命令日志_服务器名称规则id')),
            ],
            options={
                'verbose_name': '命令日志表',
