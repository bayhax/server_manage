...
class AddVersion(BaseModel):
    ...
    objects = models.Manager()
    filename = models.CharField(max_length=40, verbose_name='上传文件名')
    version = models.CharField(max_length=40, verbose_name='版本号', primary_key=True)
...
class Pattern(BaseModel):
    ...
    pattern = models.CharField(max_length=40, verbose_name='模式名称', primary_key=True)
...
class RunCompany(BaseModel):
    """运营商表模型类"""
    objects = models.Manager()
    run_company_name = models.CharField(max_length=40, verbose_name='运营商名称', primary_key=True)
...
class Plat(BaseModel):
    """平台表模型类"""
    objects = models.Manager()
    plat = models.CharField(max_length=40, verbose_name='平台', primary_key=True)
